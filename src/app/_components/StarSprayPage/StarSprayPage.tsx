                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.mainCenter}>
                    <p>
                      ...
                      하는 목표로 시작했습니다.
                      <br />
                      평소에도 소품샵이나 개인 브랜드를 운영해보고 싶다는 생각이
                      있어 직접 사이트를 제작하게 되었으며, 일본 문화에 대한
                      관심을 바탕으로 일본 소품을 중심으로 구성했습니다. 또한 그
                      분위기에 어울리는 감각적이고 독특한 디자인을 구현하기 위해
                      여러 번의 시도와 고민을 거듭했습니다.
                      <br />
                      사이트를 완성한 후에는 일본 현지 온라인 사이트에서 직접
                      상품을 소싱해 <strong>실제 판매</strong>
                      까지 이어지는 과정을 경험했습니다.
                    </p>
                  </div>
