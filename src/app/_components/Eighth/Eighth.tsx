      ...
      <div className={styles.main}>
        ...
        <div className={styles.career}>
          <div className={styles.careerInfo}>
            <p>COS 청담점 근무</p>
            <p>
              코스 청담점에서 근무하며 매장 분위기와{" "}
              <strong>서비스 품질</strong>을 세심하게 관리해, 고객에게
              편안하면서도 세련된 쇼핑 경험을 제공하고 고객 만족 향상에
              기여했습니다.
            </p>
          </div>
          <div className={styles.careerInfo}>
            ...
            <p>
              ...
              통해 최고 등급인 <strong>Ambassador</strong>를 달성했습니다. 고객
              응대, 제품 제안, 매장 경험 제공 등 전 영역에서 우수한 평가를 받아
              브랜드가 지향하는 고객 경험 수준을 성공적으로 구현했습니다.
            </p>
          </div>
        </div>
      </div>
