                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.mainCenter}>
                    <p>
                      ...
                      직접 구현한 액세서리 쇼핑 사이트입니다.
                      <br />
                      기존의 쇼핑몰들이 다소 단조롭고 일방적인 구조를 가지고
                      있다고 느껴, 사용자가 직접 반지, 귀걸이, 목걸이를 착용해볼
                      수 있는 <strong>인터랙티브한 경험</strong>을 제공하고자
                      기획했습니다.
                      <br />
                      실제 운영 사이트는 아니지만, 새로운 쇼핑몰 디자인 방향을
                      제시하기 위해 제작한 콘셉트형 프로젝트입니다.
                      <br />
                      사용자는 웹상에서 손, 귀, 목 등에 액세서리를 착용시켜보며
                      디자인을 직관적으로 확인할 수 있고, 이러한{" "}
                      <strong>참여형 인터랙션</strong>을 통해 브랜드의 감도와
                      몰입도를 강화할 수 있도록 구성했습니다.
                    </p>
                  </div>
